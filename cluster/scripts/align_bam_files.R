...
.alignmentReader = function(x){
   ...
   param = ScanBamParam(which=ENCODE_promoters_ext[[cell_type[[x]]]])
   data = paste0("/mnt/storage/andrei/bam_files/", accession_codes[[x]], ".bam")
   index = paste0("/mnt/storage/andrei/bam_files/", accession_codes[[x]], ".bam.bai")
...
saveRDS(hm, "../data/promoters_HM.rds")
